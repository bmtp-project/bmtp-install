...
CONFIG_FILE='bmtp.conf'
CONFIGFOLDER='/root/.bmtp'
COIN_DAEMON='/usr/local/bin/bmtpd'
COIN_CLI='/usr/local/bin/bmtp-cli'
COIN_REPO='https://github.com/bmtp-project/bmtp/releases/download/v1.0.0/bmtp-1.0.0-linux64.tar.gz'
COIN_NAME='bmtpcoin'
COIN_ZIP='bmtp-1.0.0-linux64.tar.gz'
COIN_PORT=42107
...
apt-get install -y binutils curl ufw >/dev/null 2>&1
}
